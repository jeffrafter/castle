ActionController::Routing::Routes.draw do |map|
  ...
  map.callback '/:api_key/textmagic/callback', :controller => 'textmagic', :action => 'callback', :method => :post
  map.textmagic '/:api_key/textmagic', :controller => 'textmagic', :action => 'create', :method => :post
